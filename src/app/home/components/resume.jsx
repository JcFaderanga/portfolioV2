...
const Resume = () => {
  return (
    <div className="w-full lg:w-110 flex gap-2 md:gap-2 items-center h-[133px] bg-[linear-gradient(to_right,#E0F7FF_0%,#FFFFFF_0%,#F5F3FF_50%,#DBEAFE_100%)] rounded-lg px-4 py-2 bg-white">
      ...
      <div className="w-full">
        ...
        <div className="flex items-center justify-evenly gap-2 pb-4 text-sm md:text-base">
          ...
          {/* PREVIEW */}
          <a
            href="/Janrey_Cyril_Faderanga_SQA_CV.pdf"
            target="_blank"
